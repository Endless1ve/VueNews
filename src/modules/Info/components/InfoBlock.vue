  ...
  <div class="info">
    ...
    <div class="content">
      ...
      <p>
        ...
        вспомогательных инструментов, препроцессора SCSS и использован модульный
        подход для создания компонентов.
      </p>
      <p>
        Это приложение позволяет пользователям легко находить и сохранять
        актуальные новости.
      </p>
      <p>
